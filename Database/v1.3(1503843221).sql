...
CREATE TABLE `article` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='文章表';-- <xjx> --
...
CREATE TABLE `category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='分类表';-- <xjx> --
...
CREATE TABLE `code` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='邀请码';-- <xjx> --
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='用户表';-- <xjx> --

-- 表的数据：article --
INSERT INTO `article` VALUES
('1','古树','<p>这是一棵很古老很古老的古树, 形状很奇特.....</p>','./Public/Uploads/2017-08-25/599fdc0211c98.jpg','1','29','1503648841','1503664204','16','0','','0','0','','','','4'),
('2','树','<p>又</p><p>一</p><p>棵古老的树!~~~~~~~~~~~~~~~~~</p><p>~~~~~~~~~~~~~~~~~~~~</p><p>~~~~~~~~~~~~~~~~~~~</p><p>~~~~~~~~~~~~~~~~~~~</p><p>~~~~~~~~~~~~~~~~~~~~~</p><p>~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~`````````````````````````````````````````````````</p>','./Public/Uploads/2017-08-25/599fee960baf0.jpg','1','29','1503653551','1503664195','18','0','','0','0','','','','4');-- <xjx> --
...
('28','文档资料','0','1','900'),
('29','古树资料','28','1','200'),
('30','规章制度','28','1','100');-- <xjx> --

-- 表的数据：code --
INSERT INTO `code` VALUES
('3','z6463684643','1','zoro');-- <xjx> --
...
('1','古树监控系统',' ','  ','./Public/Uploads/2017-08-24/599ed4b476f58.png','1','1','471593623@qq.com',' ','古树监控系统','<script type=\"text/javascript\">var cnzz_protocol = ((\"https:\" == document.location.protocol) ? \" https://\" : \" http://\");document.write(unescape(\"%3Cspan id=\'cnzz_stat_icon_1256104530\'%3E%3C/span%3E%3Cscript src=\'\" + cnzz_protocol + \"s11.cnzz.com/stat.php%3Fid%3D1256104530\' type=\'text/javascript\'%3E%3C/script%3E\"));</script>',' ',' ','<a href = \"www.baidu.com\">asd</a>','0','0','8');-- <xjx> --
...
('1','白榆','122','正常态','科属','1'),
('2','侧柏','255','警戒态','科属','2'),
('3','刺槐','150','干旱态','科属','1');-- <xjx> --

-- 表的数据：user --
INSERT INTO `user` VALUES
('1','zoropang','4aa1a3a4e966bfa691e43ecf0a28269b','./Public/Uploads/default.png','','1503233691','1503233691','::1','0','管理员','1'),
('3','zoro','670b14728ad9902aecba32e22fa4f6bd','./Public/Uploads/default.png','','1503646405','1503828576','::1','0','zoro','0');-- <xjx> --
