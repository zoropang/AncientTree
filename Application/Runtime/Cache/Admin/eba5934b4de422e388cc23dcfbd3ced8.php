            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr class="gradeU">
                        ...
                        <td>
                            <a href="<?php echo U('Maintain/doreduction',array('name'=>$vo['name']));?>" onclick="return shifou();"><button type="button" class="btn btn-w-m btn-info">还原</button></a>
                            <a href="<?php echo U('Maintain/deldata',array('name'=>$vo['name']));?>" onclick="return shifou();"><button type="button" class="btn btn-w-m btn-danger">删除</button></a>
                        </td>
                    ...
                    <div class="ibox-content">
                        <div class="hr-line-dashed"></div>
                            <form method="post" class="form-horizontal" action="<?php echo U('Maintain/dobackups');?>" enctype="multipart/form-data">
