         ...
         <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <form method="post" class="form-horizontal" action="<?php echo U('Category/doedit',array('id'=>$arr['id']));?>">
                        ...
                        <div class="form-group"><label class="col-sm-4 control-label">上级分类</label>
                                    ...
                                    <select name="fid" class="form-control m-b">
                                        ...
                                        <?php if(is_array($arrs)): foreach($arrs as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" <?php if($arr["fid"] == $vo['id']): ?>selected<?php endif; ?>><?php echo ($vo["html"]); echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                    </div>
                                </div>
                        <div class="hr-line-dashed"></div>
                                <div class="form-group has-success"><label class="col-sm-4 control-label">分类样式</label>
                                 ...
                                 <select name="type" class="form-control m-b">
                                    <?php if(is_array($category_type)): foreach($category_type as $k=>$vo): ?><option value="<?php echo ($category_type[$k]); ?>" <?php if($arr["type"] == $category_type[$k]): ?>selected<?php endif; ?>><?php echo ($k); ?></option><?php endforeach; endif; ?>
                                </select>
                                 </div>
                                </div>
                                <div class="hr-line-dashed"></div>
